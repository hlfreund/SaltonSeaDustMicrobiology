...
#SBATCH --output=metaBAT_contig_binning_6.24.23.stdout
#SBATCH --mail-user=hfreu002@ucr.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="Binning contigs from assembled mgms with metaBAT 6/24/2023"
#SBATCH -p highmem
...
do
    ...
    runMetaBat.sh -t 4 -m 1500 SSD_Contigs_CleanName.fa ${SAMPLE}_contigs_sorted.bam
    #runMetaBat.sh -t 4 -m 1500 ${SAMPLE}_contigs.fasta ${SAMPLE}_contigs_sorted.bam
    
    mv ${SAMPLE}_contigs.fasta.metabat-bins1500 ${SAMPLE}_bins_metabat
