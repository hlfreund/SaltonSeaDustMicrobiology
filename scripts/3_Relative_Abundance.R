...
wi.uniq.tg1<-ggplot(WI.uniq.b.meta[WI.uniq.b.meta$Count>0,], aes(Genus_species, Count)) +
  geom_jitter(aes(color=factor(Seas_Coll_Year),shape=Site), size=3, width=0.15, height=0) +
  scale_color_manual(name ="Collection Period", values=c("#07f49e","#2962ff","#9500ff","#ff0059","#ff8c00","#b4e600","#ffd500"), labels=c("S.1.2020"="Summer #1 2020","S.2.2020"="Summer #2 2020","S.3.2020"="Summer #3 2020","F.1.2020"="Fall #1 2020","S.1.2021"="Summer #1 2021","S.2.2021"="Summer #2 2021","F.1.2021"="Fall #1 2021")) + theme_classic() +
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),
